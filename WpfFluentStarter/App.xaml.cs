...
namespace WpfFluentStarter
{
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddApplicationServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<IUndoRedoManager<ObservableCollection<FurnitureItem>>, JsonUndoRedoManager<ObservableCollection<FurnitureItem>>>();
            services.AddSingleton<IFileStorageService<ObservableCollection<FurnitureItem>>, JsonFileStorageService<ObservableCollection<FurnitureItem>>>();
